...
@node(id='files', label='文件', leaf=False, icon=ICON_HOME)
...
@node(id='git', label='工作区', icon=ICON_GIT, condition=git_enabled)
...
@node(id='tags', label='标签', leaf=False, icon=ICON_TAGS, condition=git_enabled)
