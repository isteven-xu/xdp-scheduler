...
export const isoFormatWithoutTZ = "YYYY-MM-DDTHH:mm:ss";
export const defaultFormatWithTZ = "YYYY-MM-DD HH:mm:ss";
export const defaultTZFormat = "z (Z)";
export const dateTimeAttrFormat = "YYYY-MM-DDThh:mm:ss";
...
export const formatDateTime = (datetime) =>
  moment(datetime).format(defaultFormatWithTZ).replace("CST","");
